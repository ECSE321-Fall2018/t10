package riderz.team10.ecse321.com.riderzdrivers.navigation;
...
import riderz.team10.ecse321.com.riderzdrivers.MapsDriversActivity;
...
public class MainNavigation extends AppCompatActivity implements HttpRequestClient {
    ...
    public void mapButtons() {
        ...
        (findViewById(generatedId.get(0))).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainNavigation.this, MapsDriversActivity.class);
    ...
    private void navigateToLogin() {
        Intent intent = new Intent(this, RiderzDrivers.class);
        finish();
