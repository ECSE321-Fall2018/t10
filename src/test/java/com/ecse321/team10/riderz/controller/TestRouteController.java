...
public class TestRouteController {
	...
	*/
	...
	public void testLocation () throws Exception {
		...
		this.mockMvc.perform(post("/insertLocation/unitTest-Sav/45.4199124/-75.983142")).andDo(print()).andExpect(status().isOk())
		.andExpect(content().string(containsString("Location of unitTest-Sav has been inserted into the database.")));
		
		// Testing insert Location
		this.mockMvc.perform(post("/insertLocation/unitTest-MatSav/45.4199111/-75.983111")).andDo(print()).andExpect(status().isOk())
		...
		this.mockMvc.perform(put("/updateLocation/unitTest-MatSav/11.111111/-75.111111")).andDo(print()).andExpect(status().isOk())
		.andExpect(content().string(containsString("Location of unitTest-MatSav has been updated.")));
		
		// Testing get delete by userName
		this.mockMvc.perform(delete("/deleteLocation/unitTest-MatSav")).andDo(print()).andExpect(status().isOk())
		.andExpect(content().string(containsString("Location of unitTest-MatSav has been deleted.")));

		this.mockMvc.perform(delete("/deleteLocation/unitTest-Sav")).andDo(print()).andExpect(status().isOk())
	...
	public void testReservation () throws Exception{
		...
		this.mockMvc.perform(post("/insertReservation/unitTest-Sav/"+ tripID)).andDo(print()).andExpect(status().isOk())
		.andExpect(content().string(containsString("Reservation of unitTest-Sav has been inserted for the tripID: " + tripID)));
		
		this.mockMvc.perform(post("/insertReservation/unitTest-Sav/"+ tripID2)).andDo(print()).andExpect(status().isOk())
		...
		this.mockMvc.perform(delete("/deleteReservation/unitTest-Sav/"+ tripID)).andDo(print()).andExpect(status().isOk())
		.andExpect(content().string(containsString("Reservation of unitTest-Sav has been deleted for the tripID: " + tripID)));
		
		this.mockMvc.perform(delete("/deleteReservation/unitTest-Sav/"+ tripID2)).andDo(print()).andExpect(status().isOk())
